"""
Django settings for blazestock project.
...
SECRET_KEY = 'e_tx*teiws8xzd@ge7rj33@*l0#r_x+b8$9s=i^4qs7zyn@e@z'
...
WSGI_APPLICATION = 'blazestock.wsgi.application'
...
STATIC_URL = '/static/'
# STATICFILES_DIRS = [os.path.join(BASE_DIR, "static")],     #<-----mistake - never list, always tuple
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "blazestockapp@gmail.com"
EMAIL_HOST_PASSWORD = "tarun@123"
